...
chromosome2_maize <- as.data.frame(filter(maize_SCP, "Chromosome" == "2"))
chromosome3_maize <- as.data.frame(filter(maize_SCP, "Chromosome" == "3"))
chromosome4_maize <- as.data.frame(filter(maize_SCP, "Chromosome" == "4"))
chromosome5_maize <- as.data.frame(filter(maize_SCP, "Chromosome" == "5"))
chromosome6_maize <- as.data.frame(filter(maize_SCP, "Chromosome" == "6"))
chromosome7_maize <- as.data.frame(filter(maize_SCP, "Chromosome" == "7"))
chromosome8_maize <- as.data.frame(filter(maize_SCP, "Chromosome" == "8"))
chromosome9_maize <- as.data.frame(filter(maize_SCP, "Chromosome" == "9"))
chromosome10_maize <- as.data.frame(filter(maize_SCP, "Chromosome" == "10"))
